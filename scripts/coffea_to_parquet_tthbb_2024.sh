...
BASE_DIR="/eos/cms/store/group/phys_higgs/ttHbb/ntuples/fullyhadronic_ttH_export-bychannel"
...
for dataset_path in ${BASE_DIR}/*; do
    ...
    python -m tthbb_spanet.scripts.dataset.coffea_to_parquet \
        -i /eos/user/m/mmarcheg/ttHbb/run3/fullyhadronic/ntuples/multiple_wp_LMT_bychannel_2024/output_${dataset}.coffea \
        --cfg "$cfg" \
        -o "$output_dir" \
