...
do
    ...
    output_file="/eos/user/m/mmarcheg/ttHbb/training_datasets/classifier/multiclassifier_full_Run2_ttbb_reweighed_one_hot_encoding/tthbb_ttbar_with_ttbb_merging_ttbb_reweighed_one_hot_encoding_${year}.h5"
