...
#SBATCH --output=logs/classifier/btag_T/classifier_btag_T_%j.out
...
OPTIONS_FILE="${PROJECT_DIR}/options_files/ttHbb_fully_hadronic/classifier/options_file_Run2_Run3_sig_QCD_classifier_btag_T.json"
LOG_DIR="${PROJECT_DIR}/spanet_output/classifier_btag_T"
